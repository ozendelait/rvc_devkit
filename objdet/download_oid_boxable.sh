...
wget --no-check-certificate https://storage.googleapis.com/openimages/v6/oidv6-train-annotations-bbox.csv -P ${RVC_OID_TRG_DIR}/annotations
wget --no-check-certificate https://storage.googleapis.com/openimages/v5/validation-annotations-bbox.csv -P ${RVC_OID_TRG_DIR}/annotations
wget --no-check-certificate https://storage.googleapis.com/openimages/v5/test-annotations-bbox.csv -P ${RVC_OID_TRG_DIR}/annotations
wget --no-check-certificate https://storage.googleapis.com/openimages/v5/train-annotations-human-imagelabels-boxable.csv -P ${RVC_OID_TRG_DIR}/annotations
wget --no-check-certificate https://storage.googleapis.com/openimages/v5/validation-annotations-human-imagelabels-boxable.csv -P ${RVC_OID_TRG_DIR}/annotations
wget --no-check-certificate https://storage.googleapis.com/openimages/v5/test-annotations-human-imagelabels-boxable.csv -P ${RVC_OID_TRG_DIR}/annotations
...
wget --no-check-certificate https://storage.googleapis.com/openimages/2018_04/test/test-images-with-rotation.csv -P ${RVC_OID_TRG_DIR}/annotations
